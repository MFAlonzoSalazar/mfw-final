  ...
  return (
    <Container className="p-5">
      ...
      <StyledText className='pt-4'>
        Send me a message if you want to work together or if you just want to say hi!
      </StyledText>
      <Form action='https://formsubmit.co/f7de386e0539d64d8a701246ca3da419' method='Post' noValidate validated={validated} class="form-floating pb-5 dark-text" id="contactForm">
        {/* honeypot */}
        ...
        <StyledButton type='submit' className='mb-5' onClick={handleSubmit}>
            Submit
        </StyledButton>
      </Form>
    </Container>
